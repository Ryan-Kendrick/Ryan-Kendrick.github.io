      ...
      <div className="flex min-h-[40vh] px-5 py-12 md:flex-row flex-col items-center text-white bg-zinc-600 justify-between">
        <div className="basis-2/3 min-h-[40vh] md:border-r-4 px-2 border-amber-500 text-base  lg:flex-grow md:w-1/2  self-center">
          ...
          <p className="text-slate-200 text-lg font-medium font-sans">
            <span className="min-h-[20vh]">I</span>&apos;m Ryan and I&apos;m a
            web developer with a background in technical support and the social
            sciences. In the past few years I have been getting back to my
            technical roots, exploring what a more technical career path might
            look like. It was when I began helping out with the websites of a
            think-tank at Victoria University on a contract basis that I found
            what I was looking for. I was so fascinated by the work of my
            predecessor that I began taking coding courses. When I finally
            managed to clone down the website to start experimenting with my own
            code, it dawned on me that I had found what I was looking for. Dev
            Academy seemed like natural progression. This process of upskilling
            and orienting my career towards progressively more technical
            pursuits has been a blast, and I am looking to continue that
            journey.
          </p>
        </div>
        <div className="min-h-[40vh] basis-1/3 relative text-base  lg:flex-grow md:w-1/2  divide-l-4 self-center">
          <h2 className="text-5xl py-12 md:pt-0 bg-clip-text text-transparent bg-gradient-to-r from-red-500 to-pink-500 font-light text-center	">
            Ryan Online
          </h2>
